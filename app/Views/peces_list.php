									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('peces/exportarCSV') ?>" class="btn btn-light-primary me-3">
											...
											<tbody class="text-gray-600 fw-bold">
												...
												<?php if (!empty($peces) && is_array($peces)): ?>
													<?php foreach ($peces as $pez): ?>
														<tr>
															<td>
																<span class="<?= !is_null($pez['FECHA_BAJA']) ? 'text-danger' : '' ?>">
																	<?= esc($pez['ESPECIE']) ?>
																</span>
															</td>
																...
																<?php if ($roleName === 'Administrador'): ?>
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																		<div class="menu-item px-3">
																			<a href="<?= base_url('peces/save/' . $pez['ID_PEZ']) ?>" class="menu-link px-3">Editar</a>
																		</div>
																		<div class="menu-item px-3">
																			<a href="<?= base_url('peces/baja/' . esc($pez['ID_PEZ'])) ?>" class="menu-link px-3" onclick="return confirm('¿Estás seguro de <?= is_null($pez['FECHA_BAJA']) ? 'dar de baja' : 'dar de alta' ?> este pez?');">
																				<?= is_null($pez['FECHA_BAJA']) ? 'Dar de baja' : 'Dar de alta' ?>
																			</a>
																		</div>
																	</div>
																<?php endif; ?>
												...
												<?php else: ?>
													<tr>
														<td colspan="6" class="text-center">No hay peces registrados.</td>
													</tr>
												<?php endif; ?>
											</tbody>
											<!--end::Table body-->
	...
	<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
		...
		<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
			...
			<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
				...
				<li class="menu-item">
					<a href="https://1.envato.market/EA4JP" target="_blank" class="menu-link px-2">Compra</a>
				</li>
			</ul>
			<!--end::Menu-->
		</div>
