											...
											<tbody class="text-gray-600 fw-bold">
												<div class="container mt-5">
													...
													<form action="<?= isset($tanque) ? base_url('tanques/save/' . $tanque['ID_TANQUE']) : base_url('tanques/save') ?>" method="post">
														...
														<button type="submit" class="btn btn-primary" id="saveButton"><?= isset($tanque) ? 'Actualizar' : 'Guardar' ?></button>
	...
	<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
		...
		<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
			...
			<div class="text-dark order-2 order-md-1">
				...
				<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Tanques</a>
			</div>
			<!--end::Copyright-->
			<!--begin::Menu-->
			<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
				<li class="menu-item">
					<a href="https://keenthemes.com" target="_blank" class="menu-link px-2">Sobre Nostros</a>
				</li>
				<li class="menu-item">
