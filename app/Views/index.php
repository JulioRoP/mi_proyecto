			...
			<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content" >
						<!--begin::Toolbar-->
						<div class="toolbar" id="kt_toolbar" style="position: absolute; top: 0px;">
							<!--begin::Container-->
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<!--begin::Page title-->
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Home
									<!--begin::Separator-->
									<span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
									<!--end::Separator-->
									<!--begin::Description-->
									<small class="text-muted fs-7 fw-bold my-1 ms-1">#Inicio</small>
									...
									<div class="col-xxl-4">
										...
										<div class="card card-xxl-stretch">
											...
											<div class="card-header border-0 bg-danger py-5">
												<h3 class="card-title fw-bolder text-white">Areas de trabajo</h3>
												...
												<div class="card-p mt-n20 position-relative">
													...
													<div class="row g-0">
														...
														<div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
															...
															<!--end::Svg Icon-->
															<a href="http://localhost/mi_proyecto/public/proveedores?NOMBRE_PROVEEDOR=&TIPO_PRODUCTO=&TELEFONO=&EMAIL=&estado=activo" class="text-warning fw-bold fs-6">Proveedores</a>
														</div>
														...
														<div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
															...
															<!--end::Svg Icon-->
															<a href="http://localhost/mi_proyecto/public/peces?ESPECIE=&FECHA_NACIMIENTO=&PESO=&LONGITUD=&TIPO_AGUA=&estado=activo" class="text-primary fw-bold fs-6">Productos</a>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
													...
													<div class="row g-0">
														...
														<div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
															...
															<!--end::Svg Icon-->
															<a href="http://localhost/mi_proyecto/public/tanques?CAPACIDAD=&LOCALIZACION=&TIPO_AGUA=&estado=activo" class="text-danger fw-bold fs-6 mt-2">Tanques</a>
														</div>
										...
										<div class="card card-xxl-stretch">
											...
											<div class="card-header align-items-center border-0 mt-4">
												<h3 class="card-title align-items-start flex-column">
													<span class="fw-bolder mb-2 text-dark">Peces</span>
													<span class="text-muted fw-bold fs-7">89:034 peces</span>
												</h3>
												<div class="card-toolbar">
													<!--begin::Menu-->
											...
											<div class="card-body pt-5">
												...
												<div class="timeline-label">
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">9.500</div>
														<!--end::Label-->
														<!--begin::Badge-->
														...
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Acedias</span>
														</div>														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">2.034</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
														...
														<!--begin::Content-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Tapaculos</span>
														</div>
														<!--end::Content-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">4.200</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
														...
														<!--begin::Desc-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Doradas</span>
														</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">5.600</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
														...
														<!--begin::Text-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Delfines</span>
														</div>														<!--end::Text-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">2.700</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-danger fs-1"></i>
														...
														<!--begin::Desc-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Mantarayas</span>
														</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">8.700</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-primary fs-1"></i>
														...
														<!--begin::Text-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Boquerones</span>
														</div>														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">6.700</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-danger fs-1"></i>
														...
														<!--begin::Desc-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Peces Payasos</span>
														</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">9.800</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-success fs-1"></i>
														...
														<!--begin::Text-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Lubinas</span>
														</div>														<!--end::Text-->
													</div>
													<div class="timeline-item">
														<!--begin::Label-->
														...
														<!--begin::Desc-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Peces Luna</span>
														</div>
														<!--end::Desc-->
													</div>
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">6.650</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-danger fs-1"></i>
														...
														<!--begin::Desc-->
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Atunes</span>
														</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
											...
											<div class="card-body d-flex flex-column p-0">
												...
												<div class="flex-grow-1 card-p pb-0">
													<div class="d-flex flex-stack flex-wrap">
														<div class="me-2">
															<a href="http://localhost/mi_proyecto/public/peces?ESPECIE=&FECHA_NACIMIENTO=&PESO=&LONGITUD=&TIPO_AGUA=&estado=activo" class="text-dark text-hover-primary fw-bolder fs-3">Aumento de Peces</a>
															
														</div>
														<div class="fw-bolder fs-3 text-primary">89,034</div>
													</div>
												</div>
												<!--end::Stats-->
												<!--begin::Chart-->
