...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
	...
	<div class="d-flex flex-column flex-root">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Lista Peces</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
        ...
        <div class="container">
            <!-- Campo Usuario -->
            <div class="mb-3">
                <input type="text" name="ID_USUARIO" class="form-control" placeholder="ID de Usuario" value="<?= $usuarioBusqueda ?>">
            </div>

            <!-- Campo Pez -->
            <div class="mb-3">
                <input type="text" name="ID_PEZ" class="form-control" placeholder="ID de Pez" value="<?= $pezBusqueda ?>">
            </div>

            <!-- Campo Fecha de Pedido -->
            <div class="mb-3">
                <input type="date" name="FECHA_PEDIDO" class="form-control" placeholder="Fecha de Pedido" value="<?= isset($fechaPedidoBusqueda) ? $fechaPedidoBusqueda : '' ?>">
            </div>
        ...
        <tbody>
            <?php foreach ($pedidos as $pedido): ?>
                <tr>
                    ...
                    <td><?= $pedido['FECHA_BAJA'] ? $pedido['FECHA_BAJA'] : 'Activo' ?></td>
                    <td>
                        <!-- Botones de acción, como editar, dar de baja -->
                        <a href="<?= base_url('pedidos/edit/'.$pedido['ID_PEDIDO']) ?>" class="btn btn-warning btn-sm">Editar</a>
                        <?php if (is_null($pedido['FECHA_BAJA'])): ?>
                            <a href="<?= base_url('pedidos/baja/'.$pedido['ID_PEDIDO']) ?>" class="btn btn-danger btn-sm">Dar de baja</a>
                        <?php else: ?>
                            <a href="<?= base_url('pedidos/baja/'.$pedido['ID_PEDIDO']) ?>" class="btn btn-success btn-sm">Reactivar</a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    ...
    <div class="pagination">
        <?= $pager->links() ?>
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('pedidos/exportarCSV') ?>" class="btn btn-light-primary me-3">
...
<?php endif; ?>
									...
									<div class="card-body pt-0">
										<!--begin::Table-->
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_pedidos">
    <!--begin::Table head-->
    <thead>
        <!--begin::Table row-->
        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
            <th><a href="<?= base_url('pedidos?' . http_build_query(array_merge($_GET, ['sort' => 'USUARIO', 'order' => ($_GET['order'] ?? 'asc') === 'asc' ? 'desc' : 'asc']))) ?>">Usuario</a></th>
            <th><a href="<?= base_url('pedidos?' . http_build_query(array_merge($_GET, ['sort' => 'FECHA_PEDIDO', 'order' => ($_GET['order'] ?? 'asc') === 'asc' ? 'desc' : 'asc']))) ?>">Fecha de Pedido</a></th>
            <th><a href="<?= base_url('pedidos?' . http_build_query(array_merge($_GET, ['sort' => 'ESPECIE', 'order' => ($_GET['order'] ?? 'asc') === 'asc' ? 'desc' : 'asc']))) ?>">Pez</a></th>
            <th><a href="<?= base_url('pedidos?' . http_build_query(array_merge($_GET, ['sort' => 'ESTADO', 'order' => ($_GET['order'] ?? 'asc') === 'asc' ? 'desc' : 'asc']))) ?>">Estado</a></th>
    ...
    <tbody class="text-gray-600 fw-bold">
        <h1 class="text-center">Listado de Pedidos</h1><br><br>
                        ...
                        <?php if ($roleName === 'Administrador'): ?>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <a href="<?= base_url('pedidos/save/' . $pedido['ID_PEDIDO']) ?>" class="menu-link px-3">Editar</a>
                                </div>
                                <div class="menu-item px-3">
                                    <a href="<?= base_url('pedidos/cambiar_estado/' . esc($pedido['ID_PEDIDO'])) ?>" class="menu-link px-3" onclick="return confirm('¿Estás seguro de cambiar el estado de este pedido?');">
                                        Cambiar Estado
                                    </a>
                                </div>
                            </div>
